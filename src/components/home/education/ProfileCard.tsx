...
const ProfileCard = ({ data }: { data: ProfileProps }) => {
  ...
  return (
    <div
      className="w-full flex flex-col xl:flex-row items-start justify-between bg-black border border-gray-500 rounded-lg px-6 py-3"
      data-aos="fade-up"
      data-aos-delay="300"
    >
      <div className="w-full flex items-center gap-4">
        ...
        <div className="flex flex-col">
          <h2 className="text-lg font-semibold text-gray-300">{data?.name}</h2>
